    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(NeutralActivity.this, MenuActivity.class);
                startActivity(i);
            }
        });
        ...
        mdatabaseReference.child("Datos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot objSnapShot:dataSnapshot.getChildren()){
                    ...
                    Listperson.add(p);
                    arrayAdapter = new ArrayAdapter<NameScoreend>(NeutralActivity.this,android.R.layout.simple_list_item_1,Listperson);
